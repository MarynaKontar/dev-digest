/* /skills/:id — Skill Editor (L02). Left skill list + tabbed editor.
   Tab state lives in ?tab=. Mirrors /agents/:id page. */
"use client";
...
import { useSkills, useSkill, useUpdateSkill } from "@/hooks/skills";
